...
CREATE TABLE IF NOT EXISTS `TBLS` (
  ...
  `LAST_ACCESS_TIME` int(11) NOT NULL,
  `OWNER` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `TYPE_FIELDS` (
  ...
  `FIELD_TYPE` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `INTEGER_IDX` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `TYPES` (
  ...
  `TYPE1` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `TYPE2` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
