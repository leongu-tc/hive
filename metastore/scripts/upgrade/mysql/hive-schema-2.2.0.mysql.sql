...
CREATE TABLE IF NOT EXISTS `DBS` (
  ...
  `DB_LOCATION_URI` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `IDXS` (
  ...
  `INDEX_HANDLER_CLASS` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `INDEX_PARAMS` (
  `INDEX_ID` bigint(20) NOT NULL,
  `PARAM_KEY` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `PARAM_VALUE` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `PARTITIONS` (
  ...
  `CREATE_TIME` int(11) NOT NULL,
  `LAST_ACCESS_TIME` int(11) NOT NULL,
  `PART_NAME` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `SD_ID` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `PARTITION_EVENTS` (
  ...
  `PARTITION_NAME` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `PARTITION_KEYS` (
  ...
  `PKEY_COMMENT` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `PKEY_NAME` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `PKEY_TYPE` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `INTEGER_IDX` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `PART_COL_PRIVS` (
  ...
  `COLUMN_NAME` varchar(2048) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `CREATE_TIME` int(11) NOT NULL,
  `GRANT_OPTION` smallint(6) NOT NULL,
  `GRANTOR` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `GRANTOR_TYPE` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  ...
  KEY `PARTITIONCOLUMNPRIVILEGEINDEX` (`PART_ID`,`COLUMN_NAME`(255),`PRINCIPAL_NAME`,`PRINCIPAL_TYPE`,`PART_COL_PRIV`,`GRANTOR`,`GRANTOR_TYPE`),
...
CREATE TABLE IF NOT EXISTS `SDS` (
  ...
  `INPUT_FORMAT` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `IS_COMPRESSED` bit(1) NOT NULL,
  `IS_STOREDASSUBDIRECTORIES` bit(1) NOT NULL,
  `LOCATION` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `NUM_BUCKETS` int(11) NOT NULL,
  `OUTPUT_FORMAT` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `SERDES` (
  ...
  `NAME` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `SLIB` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `SORT_COLS` (
  `SD_ID` bigint(20) NOT NULL,
  `COLUMN_NAME` varchar(1000) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
ALTER TABLE TABLE_PARAMS MODIFY PARAM_VALUE varchar(4000) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL;
--
...
CREATE TABLE IF NOT EXISTS `TBL_COL_PRIVS` (
  ...
  KEY `TABLECOLUMNPRIVILEGEINDEX` (`TBL_ID`,`COLUMN_NAME`(255),`PRINCIPAL_NAME`,`PRINCIPAL_TYPE`,`TBL_COL_PRIV`,`GRANTOR`,`GRANTOR_TYPE`),
...
CREATE TABLE IF NOT EXISTS `TAB_COL_STATS` (
 ...
 `TABLE_NAME` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
 `COLUMN_NAME` varchar(1000) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `PART_COL_STATS` (
 ...
 `COLUMN_NAME` varchar(2048) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
 `COLUMN_TYPE` varchar(128) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
 `PART_ID` bigint(20) NOT NULL,
 `LONG_LOW_VALUE` bigint(20),
 `LONG_HIGH_VALUE` bigint(20),
...
CREATE INDEX PCS_STATS_IDX ON PART_COL_STATS (DB_NAME,TABLE_NAME,COLUMN_NAME(255),PARTITION_NAME) USING BTREE;
...
CREATE TABLE IF NOT EXISTS `TYPE_FIELDS` (
  ...
  `FIELD_TYPE` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `INTEGER_IDX` int(11) NOT NULL,
...
(
    ...
    `MASTER_KEY` VARCHAR(255) BINARY NULL,
    PRIMARY KEY (`KEY_ID`)
) ENGINE=INNODB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `FUNCS` (
  ...
  `CLASS_NAME` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_bin,
  `CREATE_TIME` INT(11) NOT NULL,
  `DB_ID` BIGINT(20),
...
CREATE TABLE IF NOT EXISTS `FUNC_RU` (
  ...
  `RESOURCE_URI` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_bin,
  `INTEGER_IDX` INT(11) NOT NULL,
